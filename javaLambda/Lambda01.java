...
public class Lambda01 {
	...
	// structured Programming ile list elemanlarinin cift olanalrini ayni satirda
	...
	// Functional Programming ile list elemanlarinin cift olanalrini ayni satirda
	// aralarina bosluk birakarak yazdiriniz
	...
	public static void ciftKarePrint(List<Integer> list) {
		...
		// map()--> bir ara islemde kullanilir.elemanları istenen isleme gore
		// degistirmek update etmek icin kullanilir.
	}
	...
	public static void ciftlerinKoku(List<Integer> list) {
	...
	//reduce()-->azaltmak ...bir cok datayi tek bir dataya(max, min carp top vb.) cevirmek icin kullanilir
